...
import QEHPhotoPlaceholder from "./QEHPhotoPlaceholder";

const themes = {
  outlet: {
    accent: "text-[#ff7a32]",
    badge: "border-[#ff5a00]/35 bg-[#ff5a00]/15 text-[#ff9a63]",
    primary:
  ...
  energies: {
    accent: "text-[#82d246]",
    badge: "border-[#82d246]/35 bg-[#69b72d]/15 text-[#a2e475]",
    primary:
  ...
  partner: {
    accent: "text-[#f2cf79]",
    badge: "border-[#f2cf79]/35 bg-[#c99532]/15 text-[#ffe7a9]",
    primary:
...
export default function QEHContextBanner({
  ...
  const colors = themes[theme] || themes.outlet;
          ...
          <div className="relative flex flex-col justify-center p-7 sm:p-10 lg:p-14">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {links.map((link, index) => (
                ...
                >
                  <span className={index === 0 ? "" : colors.accent}>
                    {link.label}
                  </span>
